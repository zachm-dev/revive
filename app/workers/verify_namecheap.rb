...
class VerifyNamecheap
  ...
  def self.moz(url)
    ...
    response = Unirest.get "http://lsapi.seomoz.com/linkscape/url-metrics/#{sites[0]}/?AccessID=#{access_id}&Expires=#{expires}&Signature=#{url_safe_signature}&Cols=103079215104"
